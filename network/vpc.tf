...
############## Route Table for VPC Endpoint for S3 #######################################################################################
# resource "aws_route_table" "private_rt" {
#   vpc_id                                                    =   "${aws_vpc.vpc.id}"
...
#   tags                                                      =   {
#     Name                                                    =   "${var.eks_cluster_name}_main_rt"
#     "kubernetes.io/cluster/${var.eks_cluster_name}"         =   "${var.eks_cluster_name}"
#     Environment                                             =   "${var.environment}"
#   }
# }
...
# # Route table and subnet associations
# resource "aws_route_table_association" "private_rt_main" {
#   count                                                     =   length(var.availability_zones)
#   subnet_id                                                 =   "${aws_subnet.private_subnet[count.index].id}"
#   route_table_id                                            =   "${aws_route_table.private_rt.id}"
# }
############## AZ2 Subnet and Route Table Configuration Completed ########################################################################
