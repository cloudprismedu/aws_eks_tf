...
##### RDS Database DB Security Group Creation ####################################################################################################
# resource "aws_security_group" "prod_eks_01_database_sg" {
#   name                                                = "prod_eks_01_database_sg"
...
# }
# ## Ingress rule1
# resource "aws_security_group_rule" "prod_eks_01_db_sg_r1" {
#   description                                         = "Allow Communictaion within VPC"
#   from_port                                           = 5432
#   protocol                                            = "tcp"
#   security_group_id                                   = aws_security_group.prod_eks_01_database_sg.id
